...
//登录页面_对象库类
public class MtxLoginPage extends BasePage {
private static Logger log = Logger.getLogger(MtxLoginPage.class);//用于eclipse工程内运行查找对象库文件路径
 public   MtxLoginPage(DriverBase driver) {
//工程内读取对象库文件
	super(driver);
