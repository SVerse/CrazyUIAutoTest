...
public class MtxTests extends MtxTestBase {
	...
	public void test003_login() throws Exception {
		...
		assertion.assertContainsText("登录成功", 10);//断言页面是否包含登录成功在10秒内
		boolean flag = operate.isElementExistTimeOut(loginActions.mtxHomePage.modvip());//另一种断言方式
